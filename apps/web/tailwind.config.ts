...
const config: Config = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      barra: '0 -6px 20px rgba(33,29,24,0.35)',
    },
    fontFamily: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'trama-suave': 'repeating-linear-gradient(135deg, rgba(33,29,24,0.06) 0 1px, transparent 1px 14px)',
        'trama-clara': 'repeating-linear-gradient(135deg, rgba(33,29,24,0.10) 0 1px, transparent 1px 12px)',
      },
