...
**GABRIEL CRISTINEL NEAMTU** es el RESPONSABLE del tratamiento de los datos personales del USUARIO y le informa de que estos datos serán tratados de conformidad con lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril (GDPR), y la Ley Orgánica 3/2018, de 5 de diciembre (LOPDGDD).
...
GABRIEL CRISTINEL NEAMTU. Carrer V Blasco Ibáñez, 16 SollanaValència (Valencia) (ES)46430 España (València).
...
Para más información sobre las garantías de privacidad, puedes dirigirte al RESPONSABLE a través de GABRIEL CRISTINEL NEAMTU. Carrer V Blasco Ibáñez, 16 SollanaValència (Valencia) (ES)46430 España E-mail: pavialbufera@gmail.com
